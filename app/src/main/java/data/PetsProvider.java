...
public class PetsProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.pets/pets/#" will map to the
        // integer code #PETS_ID. This URI is used to provide access to ONE single row
        // of the pets table.

        // In this case, the "#" wildcard is used where "#" can be substituted for an integer,
        // For example, "content://com.example.pets/pets/3" matches, but
        // "content://com.example.pets/pets" (without a number at the end) doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (match) {
            ...
            case PET_ID:
                ...
                // For an example URI such as "content://com.example.pets/pets/3",
                // the selection will be "_id=?" and the selection argument will be a
                // String array containing the actual ID of 3 in this case.

                // For every "?" in the selection, we need to have an element in the selection
                // argument that fill in the "?", Since we have 1 question mark in the
    ...
    // Updates the data at the given selection and selection arguments, with the ContentValues.
    @Override
    ...
    // specified in the selection and selection arguments (which could be 0 or 1 or pets).
    // Return the number of rows that were successfully updated.
    private int updatePet(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        // If the PetsEntry COLUMN_PET_NAME key is present,
        ...
        // If the PetsEntry COLUMN_PET_GENDER key is present,
        ...
        // If the PetsEntry COLUMN_PET_WEIGHT key is present,
