...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // in order the figure our if we're creating a new pet or editing an existing one.
        ...
        if (mCurrentPetUri == null) {
            ...
            // (It doesn't make sense to delete a pet that hasn't been changed yet.)
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.gender_male))) {
                        mGender = MALE_GENDER; // Male
                    } else if (selection.equals(getString(R.string.gender_female))) {
                        mGender = FEMALE_GENDER; // Female
                    } else {
                        mGender = UNKNOWN_GENDER; // Unknown
                    }
                }
            }
    ...
    // Prompt the user to confirm that the want to delete this pet.
    ...
    // discardButtonClickListener is the click listener for what to do when the user
